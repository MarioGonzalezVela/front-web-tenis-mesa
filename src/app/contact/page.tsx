...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Simulación de limpieza del formulario tras envío
    setTimeout(() => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black bg-opacity-90 rounded-lg">
      <div className="w-full max-w-md p-6 bg-gray-900 border border-gray-700 rounded-2xl shadow-xl">
        <h1 className="text-3xl font-bold mb-7 text-center text-gray-200">¡Contáctanos!</h1>
        <form onSubmit={handleSubmit} className="space-y-4">
          <input
            ...
            className="w-full p-2 mb-4 border border-gray-700 rounded-xl bg-gray-800 text-gray-200 hover:bg-gray-700 transition"
          />
          <input
            type="email"
            name="email"
          ...
          <textarea
            ...
            value={form.message}
            onChange={handleChange}
            className="w-full p-2 mb-6 border border-gray-700 rounded-xl bg-gray-800 text-gray-200 hover:bg-gray-700 transition resize-none h-24"
          />
          <button
            type="submit"
